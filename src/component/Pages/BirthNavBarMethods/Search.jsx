...
const Search = () => {
    ...
    return (
        <form className="max-w-md pt-40 mx-auto justify-center center grid">
            ...
            <div className="relative">
                ...
                <input type="text" id="myInput" className="block w-[800px] p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-3xl bg-gray-50 focus:ring-blue-400 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search by name..." required />
