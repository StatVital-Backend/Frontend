...
const Features = () => {
  return (
    <div className='mainContainer md:px-20'>

      <div className='justify-center font-bold center md:px-20 flex mt-32 font-sans' >
            <p className='text-black text-5xl'>Explore Our Features</p>
      </div> 
          ...
          <div className='flex gap-60 firstThreeDiv'>
            ...
            <div className='service2'>
              ...
              <div className="uppercase text-blue-400 text-2xl font-bold">Accessibility and Integration</div>
                  ...
                  and collaboration across healthcare settings.
                  </p>
              </div>
            </div>
