  ...
  return (
    <div className='mainContainer'>
      ...
      <div className='flex justify-center center gap-40 pt-12 pr-20 serviceDiv'>
        ...
        <p>  With intuitive interfaces and seamless integration <br />
        ...
        <div className='allService'>
          <div className='flex gap-60 firstThreeDiv'>
            <div className='service1'>
              ...
              <p>Our system is designed with compliance and <br /> security in mind, 
                regular security updates, <br /> and comprehensive audit trails to protect <br /> sensitive information. With built-in validation <br />
                 ...
                 you can trust that <br /> your records are secure and compliant.
            ...
            <div className='service2'>
              ...
              <p>our system seamlessly integrates with your existing hospital <br /> information systems and government databases, enabling <br />
          ...
          <div className='flex gap-36 pt-12 secondThreeDiv'>
            <div className='service4'>
              ...
              <p> we offer flexible solutions that scale with your organization, <br /> whether you're a small community hospital or a large <br /> metropolitan mortuary.
            ...
            <div className='service5'>
              ...
              <p>  Our dedicated team provides comprehensive <br /> training and ongoing support to ensure that <br /> you get the most out of our system. From user <br /> manuals and video tutorials to live support <br />
