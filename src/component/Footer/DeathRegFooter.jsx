  ...
  return (
    ...
    <div className="bg-gray-100">
      <div className="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
        <div className="p-5">
          <h3 className="font-bold text-xl text-blue-400">StatVital</h3>
        </div>
        <div className="p-5">
          <div className="text-sm uppercase text-blue-400 font-bold">Resources</div>
        ...
        <div className="p-5">
          <div className="text-sm uppercase text-blue-400 font-bold">Support</div>
        ...
        <div className="p-5">
          <div className="text-sm uppercase text-blue-400 font-bold">Contact us</div>
          <a href="/#" className="my-3 block">312 Herbert Macaulay way, Sabo Yaba Lagos<span className="text-teal-600 text-xs p-1"></span></a>
          <a href="/#" className="my-3 block">statvital@statvital.com <span className="text-teal-600 text-xs p-1"></span></a>
        </div>
      </div>

      <div className="bg-gray-100 pt-2">
        <div className="flex pb-5 px-3 m-auto pt-5 border-t text-blue-400 text-sm flex-col max-w-screen-lg items-center">
          <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
            <a href="/#" className="w-6 mx-1">
              <svg className="fill-current cursor-pointer text-blue-400 hover:text-blue-400" width="100%" height="100%" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
