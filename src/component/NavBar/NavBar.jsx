...
const NavBar = () => {
  return (
    <div className='bg-blue-950 h-24 flex justify-around mainContainer'>
            ...
            <div className='w-32 items-center flex bg-blue-950'>
              <p className='text-3xl text-white pt-9'>STATVITAL</p>
                {/* <img src={logo} alt="web logo" style={{ width: '250px', height: 'auto' }}/> */}
            </div>
              <div className='flex gap-96'>

              <div className='items-center gap-20 flex hover:scale-110 transition duration-500 pt-4 cursor-pointer object-cover justify-center center hover:text-blue-400 text-white pl-20'>
                ...
                <div className='flex gap-10  pt-5 btn'>
