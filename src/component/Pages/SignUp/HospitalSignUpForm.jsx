        ...
        <div className="flex justify-center items-center h-screen">
            <div className="bg-white rounded-sm p-6 text-center">
             <img src={hospitalLogo} alt="Hospital Logo" className="mb-5 mx-auto" />
                <h2 className="text-4xl font-bold text-blue-900 text-center mb-8">SIGN UP AS HOSPITAL</h2>
                <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-10">
                    <div>
                        <label htmlFor="facilityName" className="block text-blue-900 font-bold mb-2 text-3xl">Facility Name</label>
                        <input
                            type="text"
                            id="facilityName"
                    ...
                    <div>
                        <label htmlFor="facilityLocation" className="block text-blue-900 font-bold mb-2 text-3xl">Facility Location</label>
                        <input
                            type="text"
                            id="facilityLocation"
                            className="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full py-2.5 px-4"
                    ...
                    <div>
                        <label htmlFor="facilityType" className="block text-blue-900 font-bold mb-2 text-3xl">Facility Type</label>
                        <select
                            id="facilityType"
                            className="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full py-2.5 px-4"
                            value={facilityType}
                    ...
                    <div>
                        <label htmlFor="certificationNumber" className="block text-blue-900 font-bold mb-2 text-3xl">Certification Number</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label htmlFor="phoneNumber" className="block text-blue-900 font-bold mb-2 text-3xl">Phone Number</label>
                        <input
                            type="tel"
                            id="phoneNumber"
                            className="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full py-2.5 px-4"
                    ...
                    <div>
                        <label htmlFor="password" className="block text-blue-900 font-bold mb-2 text-3xl">Password</label>
                        <input
                            type="password"
                            id="password"
                            className="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full py-2.5 px-4"
                    ...
                    <div>
                        <label htmlFor="confirmPassword" className="block text-blue-900 font-bold mb-2 text-3xl">Password</label>
                        <input
