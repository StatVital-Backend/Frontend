  ...
  return (
    <div className='flex justify-center center'>
      <div className='flex pt-10 pr-40 '>
        ...
        <p className='text-blue-400 font-bold font-sans text-4xl txt px-32'>ABOUT STATVITAL</p>
        ...
        for various purposes. Here's what you can expect from our service:</p> <br />
          <p className='text-blue-400 font-extrabold text-2xl' >Reliability and Accuracy: </p>
          ...
          <p className='text-blue-400 font-extrabold text-2xl' >Ease Of Access: </p>
          ...
          <p className='text-blue-400 font-extrabold text-2xl' >Privacy And Security: </p>
          ...
          <p className='text-blue-400 font-extrabold text-2xl' >Customer Support: </p>
          ...
          <p className='text-blue-400 font-bold font-sans text-4xl txt px-32'>OUR VISION</p>
        ...
        is centered on leveraging technology to improve efficiency, accessibility, and accountability in the management of vital statistics, <br />
          ...
          <p className='text-blue-400 font-bold font-sans text-4xl txt px-32'>OUR MISSION</p>
