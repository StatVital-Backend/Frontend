...
const MorgueSignUp = () => {
              ...
              <div className="p-6  w-[700px]  space-y-4 md:space-y-6 sm:p-8">
                <h1 className="text-xl font-bold leading-tight justify-center flex tracking-tight text-blue-950 md:text-3xl">
                  ...
                  <div>
                    ...
                    <input type="text" id="facility_name" className="facilityName border text-blue-950 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-white border-blue-950 placeholder-blue-950 focus:ring-blue-950 focus:border-blue-950" placeholder="Mortuary Name" required />
                  </div>
                    ...
                    <div>
                      ...
                      focus:border-primary-600 block w-full p-2.5 bg-white border-blue-950 placeholder-blue-950 focus:ring-blue-950 focus:border-blue-950" placeholder="Mortuary location" required=""/>
                    </div>
                    ...
                    <div>
                      ...
                      focus:border-primary-600 block w-full p-2.5 bg-white border-blue-950 placeholder-blue-950 focus:ring-blue-950 focus:border-blue-950" placeholder="name@mortuary.com" required=""/>
                    </div>
                    <div>
                    ...
                    <div> 
                      <Link to="/login"> <FilledButton text={"Login"} style={{width:"640px"}} /> </Link>   
                    </div>
                      <p class="text-sm font-light text-blue-950">
                          Already have an account yet? <a href="/login" class="font-medium hover:underline text-blue-400">login here</a>
                      </p>
    ...
    <div className="bg-blue-950 h-screen px-32 center w-[1700px]">
      
      <div className="text-5xl pt-96 text-white">
