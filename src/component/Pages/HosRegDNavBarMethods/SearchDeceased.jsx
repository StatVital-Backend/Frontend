...
const Card = ({ deceasedName, age, dateOfDeath, causeOfDeath, gender }) => {
    return (
        <div className="bg-white mr-12 shadow-md rounded-lg p-6 mb-4 w-[250px] ">
            <h2 className="text-xl font-bold mb-2">{deceasedName}</h2>
            <p>Age: {age || 'Unknown'}</p>
...
export default HosRegDeathSearch;
