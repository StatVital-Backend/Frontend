    ...
    <div className=''> 
      ...
      <div className=' justify-center pt-6 flex gap-4 mainContainer'>
          <div className=' pt- 20 addChild'>
            <FilledButton text="Add Child" style={{width: "200px", height: 86}}/>
          </div>
          ...
          <div className=' pt- 20 addChild'>
            <FilledButton text="Update Child" style={{width: "200px", height: 86}}/>
          </div>

          <div className=' pt- 20 addChild'>
            <FilledButton text="Delete Child" style={{width: "200px", height: 86}}/>
          </div>
